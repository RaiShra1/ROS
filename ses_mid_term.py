...
class OffbPosCtl:
    ...
    locations = numpy.matrix([[02.0, 00.0, 01.0, quaternion_from_euler(0, 0, 0)[0],quaternion_from_euler(0, 0, 0)[1], quaternion_from_euler(0, 0, 0)[2],quaternion_from_euler(0, 0, 0)[3]],
                              ...
                              [12.5, -65, 0.0, quaternion_from_euler(0, 0, -3.14 / 2)[0],quaternion_from_euler(0, 0, -3.14 / 2)[1],quaternion_from_euler(0, 0, -3.14 / 2)[2],quaternion_from_euler(0, 0, -3.14 / 2)[3]],
