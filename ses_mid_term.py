...
class OffbPosCtl:
    ...
    locations = numpy.matrix([[2, 0, 1, quaternion_from_euler(0, 0, 0)[0],quaternion_from_euler(0, 0, 0)[1], quaternion_from_euler(0, 0, 0)[2],quaternion_from_euler(0, 0, 0)[3]],
                              [2, 0, 5, quaternion_from_euler(0, 0, 0)[0], quaternion_from_euler(0, 0, 0)[1],quaternion_from_euler(0, 0, 0)[2],quaternion_from_euler(0, 0, 0)[3]],
                              [20, -4, 15, quaternion_from_euler(0, 0, 0)[0], quaternion_from_euler(0, 0, 0)[1],quaternion_from_euler(0, 0, 0)[2],quaternion_from_euler(0, 0, 0)[3]],
                              [40, -6, 15,quaternion_from_euler(0, 0, -3.14 / 2)[0],quaternion_from_euler(0, 0, -3.14 / 2)[1],quaternion_from_euler(0, 0, -3.14 / 2)[2],quaternion_from_euler(0, 0, -3.14 / 2)[3]],
                              [60.0, -9.0, 19,quaternion_from_euler(0, 0, -3.14 / 2)[0], quaternion_from_euler(0, 0, -3.14 / 2)[1],quaternion_from_euler(0, 0, -3.14 / 2)[2],quaternion_from_euler(0, 0, -3.14 / 2)[3]],
                              [59.5, -9.5, 19, quaternion_from_euler(0, 0, -3.14 / 3)[0], quaternion_from_euler(0, 0, -3.14 / 3)[1], quaternion_from_euler(0, 0, -3.14 / 3)[2],quaternion_from_euler(0, 0, -3.14 / 3)[3]],
